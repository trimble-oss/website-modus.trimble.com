...
- Form inputs that are in **Active** should have a 4dp border using our active color : {{< color-preview hex="#0C77BE" >}}. labled\*\* should be: {{< color-preview hexL="#ByB9C3" hexD="#019AEB" >}}.
