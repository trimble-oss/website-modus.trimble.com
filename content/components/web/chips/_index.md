...
{{< img src="/img/components/chips-example.svg" dark="/img/components/chips-example-dark.svg" class="border bg-light" width="400" height="300" alt="Chips example" loading="auto" >}}
