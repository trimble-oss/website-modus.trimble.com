          ...
          (i.updateSC = function (e, t) {
            ...
            if (
              ...
              !e &&
                ...
                i.sc.maxHeight ||
                  (i.sc.maxHeight = parseInt((window.getComputedStyle ? getComputedStyle(i.sc, null) : i.sc.currentStyle).maxHeight)),
              ...
              if (t) {
                ...
                n + i.sc.suggestionHeight - i.sc.maxHeight > 0
                  ? (i.sc.scrollTop = n + i.sc.suggestionHeight + s - i.sc.maxHeight)
          ...
          if ((40 == t || 38 == t) && i.sc.innerHTML) {
            ...
            return (
              s
                ...
                : ((o = 40 == t ? i.sc.querySelector('.autocomplete-suggestion') : i.sc.childNodes[i.sc.childNodes.length - 1]),
                  (o.className += ' selected'),
                  console.log(o),
                  (i.value = o.getAttribute('data-val'))),
              i.updateSC(0, o),
